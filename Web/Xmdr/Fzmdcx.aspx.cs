...
namespace Web.Xmdr
{
    public partial class Fzmdcx : TStar.Web.BasePage
    {
        #region 自定义属性

        string DefBll = "fzmdcx";
        string DefSort = "Xh";
        ...
        private void BindData()
        {
            ...
            string tblname = TU.Globals.TripleDESEncrypt("发展对象" + BLL.Globals.SystemSetting.EncryptCode);
        ...
        protected void btnDeleteSel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                BLL.Lcgl.Lc_fzmd.Delete(bhs.Substring(1).Split(','));
                this.BindGrid();
        ...
        protected void btnClear_Click(object sender, EventArgs e)
        {
            try
            {
                BLL.Lcgl.Lc_fzmd.ClearImport(TStar.Web.Globals.Account.DeptPkid, this.ddlDzb.SelectedIndex > 0 ? this.ddlDzb.SelectedValue : null);
                this.BindGrid();
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                BLL.Lcgl.Lc_fzmd.Submit(TStar.Web.Globals.Account.DeptPkid, this.ddlDzb.SelectedIndex > 0 ? this.ddlDzb.SelectedValue : null);
                this.BindGrid();
