<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nfzmdcx.aspx.cs" Inherits="Web.Xmdr.Nfzmdcx" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="pnlFit" runat="server" Layout="VBox" BoxConfigAlign="Stretch" BoxConfigPadding="1" BoxConfigChildMargin="0 0 0 0" ShowBorder="false" ShowHeader="false">
            <Items>                       
                <%--查询条件框--%>        
                <f:Panel runat="server" Title="拟发展名单" ShowBorder="true" ShowHeader="true" EnableCollapse="true" CssClass="querypanel">
                    <Items>
                        <f:ContentPanel runat="server" ShowBorder="false" ShowHeader="false" BodyPadding="15 15 10 0">
                            ...
                            <f:DropDownList runat="server" ID="ddlDbjg" Label="答辩结果" LabelWidth="75" LabelAlign="Right" Width="175px" AutoPostBack="true" OnSelectedIndexChanged="ddl_SelectedIndexChanged"></f:DropDownList>
