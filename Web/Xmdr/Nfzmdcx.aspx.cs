...
namespace Web.Xmdr
{
    public partial class Nfzmdcx : TStar.Web.BasePage
    {
        #region 自定义属性
        ...
        private void BindData()
        {
            ...
            TUF.Helper.BindDropDownList(BLL.Globals.SystemCode.DtDm_jgzt, this.ddlDbjg, "Mc", "Dm", null, null, "__", "－不限－");
            
            string tblname = TU.Globals.TripleDESEncrypt("拟发展对象" + BLL.Globals.SystemSetting.EncryptCode);
        ...
        protected void btnDeleteSel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                BLL.Lcgl.Lc_nfzmd.Delete(bhs.Substring(1).Split(','));
                this.BindGrid();
        ...
        protected void btnClear_Click(object sender, EventArgs e)
        {
            try
            {
                BLL.Lcgl.Lc_nfzmd.ClearImport(TStar.Web.Globals.Account.DeptPkid, this.ddlDzb.SelectedIndex > 0 ? this.ddlDzb.SelectedValue : null);
                this.BindGrid();
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                BLL.Lcgl.Lc_nfzmd.Submit(TStar.Web.Globals.Account.DeptPkid, this.ddlDzb.SelectedIndex > 0 ? this.ddlDzb.SelectedValue : null);
                this.BindGrid();
