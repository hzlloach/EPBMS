<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Slx.aspx.cs" Inherits="Web.Xmgl.Slx" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="pnlFit" runat="server" Layout="VBox" BoxConfigAlign="Stretch" BoxConfigPadding="1" BoxConfigChildMargin="0 0 0 0" ShowBorder="false" ShowHeader="false">
            <Items>                       
                <%--查询条件框--%>        
                <f:Panel runat="server" Title="其他项目" ShowBorder="true" ShowHeader="true" EnableCollapse="true" CssClass="querypanel">
                    <Items>
                        <f:ContentPanel runat="server" ID="ContentPanel1" ShowBorder="false" ShowHeader="false" BodyPadding="15 15 10 0">
                            <f:DropDownList runat="server" ID="ddlDjbh" Label="联系类别" LabelWidth="75" LabelAlign="Right" Width="225px" AutoPostBack="true" OnSelectedIndexChanged="ddlKhzb_SelectedIndexChanged"></f:DropDownList>
                            <f:ToolbarText runat="server" Text="　" CssClass="titleSeparatorSmall" Hidden="true"></f:ToolbarText> 
                            <f:TwinTriggerBox ID="ttbSearch" runat="server" Label="关键字" LabelWidth="62" LabelAlign="Right" Width="312px" EmptyText="请输入联系内容，支持模糊查询" ShowTrigger1="false" Trigger1Icon="Clear" Trigger2Icon="Search" OnTrigger1Click="ttbSearch_Trigger1Click" OnTrigger2Click="ttbSearch_Trigger2Click"></f:TwinTriggerBox>
                    ...
                    <Items>
                        <f:Grid ID="Grid1" runat="server" Title="Grid1" EmptyText="<img src='/res/images/no_data_found.jpg' alt='暂无数据'/>" AllowPaging="true" AllowSorting="true" EnableCheckBoxSelect="true" EnableTextSelection="true" ShowBorder="false" ShowHeader="False" IsDatabasePaging="true" DataKeyNames="Pkid,Ztdm,Yxsc,Fjsl" OnPageIndexChange="Grid1_PageIndexChanged" OnSort="Grid1_Sort" OnRowCommand="Grid1_RowCommand" OnPreRowDataBound="Grid1_PreRowDataBound" OnRowDataBound="Grid1_RowDataBound">
                            <Columns>
                                ...
                                <f:BoundField Width="90px" ColumnID="Zbmc" DataField="Zbmc" HeaderText="项目类别" Hidden="true"/>
                                <f:BoundField Width="90px" ColumnID="Djmc" DataField="Djmc" SortField="Djmc" HeaderText="联系类别"/>
                                <f:BoundField Width="100px" ColumnID="Xmrq" DataField="Xmrq" SortField="Xmrq" HeaderText="联系日期" />
                                <f:TemplateField Width="350px" ColumnID="Xmmc" SortField="Xmmc" HeaderText="联系内容">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="lblXmmc" runat="server" Text='<%# Eval("Xmmc").ToString().Substring(11) %>' NavigateUrl='javascript:;' ToolTip="点击浏览"></asp:HyperLink>
                                    </ItemTemplate>
                                </f:TemplateField>
                                ...
                                <f:WindowField Width="50px" ColumnID="lbfModify" TextAlign="Center" WindowID="wndEdit" Icon="Pencil" HeaderText="编辑" ToolTip="编辑" DataIFrameUrlFields="Pkid,Zbbh" DataIFrameUrlFormatString="SlxEdit.aspx?pkid={0}&zb={1}" Title="弹出窗－修改" />
    ...
    <f:Window ID="wndEdit" runat="server" Title="弹出窗－新增" WindowPosition="Center" Target="Self" Width="1000px" Height="700px" EnableMaximize="false" EnableResize="false" EnableDrag="false" EnableIFrame="true" IsModal="true" Hidden="true" CloseAction="Hide" OnClose="Window_Close">
    </f:Window> 
