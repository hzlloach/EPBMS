...
namespace Web.Xmgl
{
    public partial class Slx : TStar.Web.BasePage
    {
        #region 自定义属性

        string DefBll = "yjxmcx_cur";
        string DefSort = "Zbdm,Xmrq DESC";
        string DefSortFirst = "";

        // 项目类别编号
        private string Zbbh
        {
            get { return TU.Globals.BindSystemCode(BLL.Globals.SystemCode.DtJd_khzbLocal, "Zbmc", "Pkid", "三联系情况", ""); }
        }
        ...
        private void BindData()
        {
            ...
            btnAddNew.OnClientClick = wndEdit.GetShowReference("SlxEdit.aspx?zb=" + Zbbh, "弹出窗－新增") + "return false;";
        ...
        private bool GetQueryResult()
        {
            ...
            //if (this.ddlXmdj.SelectedIndex > 0)
            //    cond += String.Format(" AND Djbh='{0}'", this.ddlXmdj.SelectedValue);
            //if (this.ddlXmzt.SelectedIndex > 0)
            //    cond += String.Format(" AND Ztbh='{0}'", this.ddlXmzt.SelectedValue);
        ...
        protected void Grid1_RowDataBound(object sender, GridRowEventArgs e)
        {
            ...
            lblXmmc.Attributes["onclick"] = wndView.GetShowReference(String.Format("SlxView.aspx?pkid={0}", Grid1.DataKeys[e.RowIndex][0].ToString()), "弹出窗－浏览");
        }
