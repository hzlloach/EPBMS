...
namespace Web.Xmgl
{
    public partial class Xmsb : TStar.Web.BasePage
    {
        #region 自定义属性
        ...
        private void BindData()
        {
            ...
            btnAddNew.OnClientClick = wndEdit.GetShowReference("XmsbEdit.aspx?zb=" + Zbbh, "弹出窗－新增") + "return false;";
        ...
        private bool GetQueryResult()
        {
            ...
            string cond = string.Format("(Zbqx='P' OR Sfgd='false') AND {0}", BLL.Globals.SystemSetting.CondXsbhFzzt);
            if (this.ddlKhzb.SelectedIndex > 0)
                cond += String.Format(" AND Zbdm LIKE '{0}%'", this.ddlKhzb.SelectedValue.Replace("0", ""));
