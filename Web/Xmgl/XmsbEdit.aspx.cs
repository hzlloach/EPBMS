...
namespace Web.Xmgl
{
    public partial class XmsbEdit : TStar.Web.BasePage
    {
        #region 自定义属性
        ...
        private void BindData()
        {
            ...
            // 绑定项目类别
            TUF.Helper.BindTreeView(BLL.Globals.SystemCode.DtTree_khzbLocalOther, this.ddlZbbh, "id", "－请选择－");
            //this.ddlZbbh.SelectedValue = Zbbh;
            //this.ddlZbbh.Enabled = false;
        ...
        protected void ddlZbbh_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            TUF.Helper.BindDropDownList(BLL.Globals.SystemCode.DtJd_xmdjLocal, this.ddlDjbh, "Djmc", "Pkid", null, filter, "__", "－请选择等级－");
