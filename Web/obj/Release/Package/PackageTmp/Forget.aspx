    ...
    <form id="form1" runat="server">
        ...
        <f:SimpleForm runat="server" ID="SimpleForm1" BodyPadding="10" LabelWidth="70" ShowBorder="false" ShowHeader="false">
            <Toolbars>
                <f:Toolbar ID="Toolbar1" runat="server">
                    <Items>
                        ...
                        <f:Button runat="server" ID="btnSave" Text="重置" Icon="SystemSave" ConfirmText="确认重置？" ValidateForms="SimpleForm1" OnClick="btnSave_Click"></f:Button>
            ...
            <Items>
                ...
                <f:TextBox runat="server" ID="tbxXh" Label="学号/工号" MaxLength="12" Required="true" ></f:TextBox>
                ...
                <f:Panel ID="Panel1" runat="server" BodyPadding="0 0 7 0" Layout="Column" CssClass="formitem" ShowBorder="false" ShowHeader="false">
                    <Items>
                        ...
                        <f:Button runat="server" ID="btnSend" Text="获取验证码" ColumnWidth="30%" OnClientClick="ajaxGetVerifyCode('SimpleForm1_tbxXh-inputEl', 'SimpleForm1_tbxSjhm-inputEl', 'SimpleForm1_Panel1_btnSend', 'SimpleForm1_Panel1_hfdCode-inputEl',1);return false;"></f:Button>
