<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Fzdxlb.aspx.cs" Inherits="Web.Fzgl.Fzdxlb" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" Layout="VBox" BoxConfigAlign="Stretch" BoxConfigPadding="1" BoxConfigChildMargin="0 0 0 0" ShowBorder="false" ShowHeader="false">
            <Items>                       
                <%--查询条件框--%>        
                <f:Panel ID="Panel2" runat="server" Title="发展对象列表" ShowBorder="true" ShowHeader="true" EnableCollapse="true" CssClass="querypanel">
                    <Items>
                    ...
                    <Items>
                        <f:Grid ID="Grid1" runat="server" Title="Grid1" EmptyText="<img src='/res/images/no_data_found.jpg' alt='暂无数据'/>" AllowPaging="true" AllowSorting="true" EnableCheckBoxSelect="true" EnableTextSelection="true" ShowBorder="false" ShowHeader="False" IsDatabasePaging="true" DataKeyNames="Pkid" OnPageIndexChange="Grid1_PageIndexChanged" OnSort="Grid1_Sort" OnRowCommand="Grid1_RowCommand">
                            <Columns>
                                ...
                                <f:BoundField Width="120px" ColumnID="Dxjyrq" DataField="Dxjyrq" SortField="Dxjyrq" HeaderText="党校结业日期" />
    ...
    <f:Window ID="wndImport" runat="server" Title="新增" WindowPosition="Center" Target="Self" Width="500px" Height="300px" EnableMaximize="true" EnableResize="false" EnableDrag="true"  EnableIFrame="true" Hidden="true" IsModal="true" CloseAction="Hide" OnClose="Window_Close">
    </f:Window>   
