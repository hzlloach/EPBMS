<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Fzjd.aspx.cs" Inherits="Web.Tjbb.Fzjd" %>
                ...
                <f:TabStrip runat="server" ID="tabStrip1" TabPosition="Top" ActiveTabIndex="0" ShowBorder="true" EnableTabCloseMenu="false">
                    <Tabs>
                        <f:Tab runat="server" ID="tabXmxx" Title="按学院统计" BodyPadding="10" Layout="Fit">
                            <Items>
                                <f:Grid ID="grdXy" runat="server" Title="Grid1" EmptyText="<img src='/res/images/no_data_found.jpg' alt='暂无数据'/>" AllowPaging="false" AllowSorting="true" EnableCheckBoxSelect="false" EnableTextSelection="true" ShowBorder="false" ShowHeader="false" IsDatabasePaging="false" DataKeyNames="Pkidl" OnSort="Grid1_Sort">
                                    <Columns>
                        ...
                        <f:Tab runat="server" ID="tabZmcl" Title="按学院党支部统计" BodyPadding="10" Layout="Fit">
                            <Items> 
                                <f:Grid ID="grdXydzb" runat="server" Title="Grid1" EmptyText="<img src='/res/images/no_data_found.jpg' alt='暂无数据'/>" AllowPaging="false" AllowSorting="true" EnableCheckBoxSelect="false" EnableTextSelection="true" ShowBorder="false" ShowHeader="false" IsDatabasePaging="false" DataKeyNames="Pkidl" OnSort="Grid1_Sort">
                                    <Columns>
                                        <f:RowNumberField EnablePagingNumber="true" />
                        ...
                        <f:Tab runat="server" ID="tab1" Title="按学院专业统计" BodyPadding="10" Layout="Fit">
                            <Items> 
                                <f:Grid ID="grdXyzy" runat="server" Title="Grid1" EmptyText="<img src='/res/images/no_data_found.jpg' alt='暂无数据'/>" AllowPaging="false" AllowSorting="true" EnableCheckBoxSelect="false" EnableTextSelection="true" ShowBorder="false" ShowHeader="false" IsDatabasePaging="false" DataKeyNames="Pkidl" OnSort="Grid1_Sort">
                                    <Columns>
                                        <f:RowNumberField EnablePagingNumber="true" />
