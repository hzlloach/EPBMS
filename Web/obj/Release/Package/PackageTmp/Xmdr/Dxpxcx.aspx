<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dxpxcx.aspx.cs" Inherits="Web.Xmdr.Dxpxcx" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="pnlFit" runat="server" Layout="VBox" BoxConfigAlign="Stretch" BoxConfigPadding="1" BoxConfigChildMargin="0 0 0 0" ShowBorder="false" ShowHeader="false">
            <Items>                       
                <%--查询条件框--%>        
                <f:Panel runat="server" Title="党校培训" ShowBorder="true" ShowHeader="true" EnableCollapse="true" CssClass="querypanel">
                    <Items>
                        <f:ContentPanel runat="server" ShowBorder="false" ShowHeader="false" BodyPadding="15 15 10 0">
                            <f:DropDownList runat="server" ID="ddlDjbh" Label="考核等级" LabelWidth="75" LabelAlign="Right" Width="205px" AutoPostBack="true" OnSelectedIndexChanged="ddlDjbh_SelectedIndexChanged"></f:DropDownList>
                    ...
                    <Items>
                        <f:Grid ID="Grid1" runat="server" Title="Grid1" EmptyText="<img src='/res/images/no_data_found.jpg' alt='暂无数据'/>" AllowPaging="true" AllowSorting="true" EnableCheckBoxSelect="true" EnableTextSelection="true" ShowBorder="false" ShowHeader="False" IsDatabasePaging="true" DataKeyNames="Pkid,Fzrbh" OnPageIndexChange="Grid1_PageIndexChanged" OnSort="Grid1_Sort" OnRowCommand="Grid1_RowCommand" >
                            <Columns>
                                ...
                                <f:TemplateField Width="80px" ColumnID="Xmmc" SortField="Xmmc" HeaderText="期数">
                                    <ItemTemplate>
                                        <asp:Label ID="lblXmmc" runat="server" Text='<%# Eval("Xmmc").ToString().Replace("党校培训","") %>'></asp:Label>
                                    </ItemTemplate>
                                </f:TemplateField>
                                <f:BoundField Width="100px" ColumnID="Xmrq" DataField="Xmrq" SortField="Xmrq" HeaderText="培训日期" />
                                <f:BoundField Width="90px" ColumnID="Djmc" DataField="Djmc" SortField="Djmc" HeaderText="考核等级" />
