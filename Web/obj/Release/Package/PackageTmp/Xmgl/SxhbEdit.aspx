        ...
        <f:SimpleForm runat="server" ID="SimpleForm1" Layout="VBox" BodyPadding="10" LabelWidth="70" ShowBorder="true" ShowHeader="false">
            ...
            <Items> 
                ...
                <f:Panel runat="server" ShowBorder="false" ShowHeader="false" BoxFlex="1" Layout="Fit" BodyPadding="0 0 0 0" CssClass="PnlHbnr">  
                    <Items>
                        <f:TextArea runat="server" ID="tbxHbnr" Label="敬爱的党组织" LabelAlign="Top" MaxLength="1000" EmptyText="请输入汇报内容正文，限填 500 ～ 1000 个汉字 ！" Required="true" Hidden="false"></f:TextArea>
                    </Items>
                </f:Panel>                
                    ...
                    <Items>
                        <f:ContentPanel ID="ContentPanel1" runat="server" ShowBorder="false" ShowHeader="false" Height="25px">
                            <div style="text-align:right;color:gray; margin-top:5px">
                                <span>限填 </span><asp:Label runat="server" ForeColor="Black" Font-Bold="true" Text="500～1000"></asp:Label><span> 字，已输入 </span><asp:Label runat="server" ID="lblYsr" ForeColor="Red" Font-Bold="true" Text="521"></asp:Label><span> 字，还可输入 </span><asp:Label runat="server" ID="lblKsr" ForeColor="Blue" Font-Bold="true" Text="521"></asp:Label><span> 字 ！</span>
                            </div>
                        </f:ContentPanel>
                    </Items>
                </f:Panel>           
    ...
    <script type="text/javascript">
        ...
        F.ready(function () {
            ...
            function setYsr(zsYsr) {
                ...
                var zsKsr = 1000 - parseInt(zsYsr, 10);
                $("[id$='lblKsr']").html(zsKsr);

                if (zsYsr >= 500 && zsYsr <= 1000) {
                    //btnSave.enable();
                    btnSubm.enable();
                }
                else {
