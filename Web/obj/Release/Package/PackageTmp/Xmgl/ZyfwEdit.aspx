<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZyfwEdit.aspx.cs" Inherits="Web.Xmgl.ZyfwEdit" %>
                                ...
                                <f:SimpleForm ID="SimpleForm1" runat="server" ShowBorder="false" ShowHeader="false">
                                    <Items>
                                        ...
                                        <f:Panel ID="Panel2" runat="server" BodyPadding="0 0 15 0" Layout="Column" CssClass="formitem" ShowBorder="false" ShowHeader="false">
                                            <Items>    
                                                <f:DatePicker runat="server" ID="dtpXmrq" Label="服务日期" Margin="0 15 0 0" ColumnWidth="70%" EnableEdit="false" Required="true" ShowRedStar="True"></f:DatePicker>
                                                <f:DropDownList runat="server" ID="ddlZbbh" Label="项目类别" Width="300px" Hidden="true" Required="true" ShowRedStar="true"></f:DropDownList>                   
                                                <f:Label runat="server" ID="lblZbmc" Label="项目类别" ColumnWidth="30%" Text=""></f:Label>
                                            </Items>
                                        </f:Panel>
                                        <f:Panel ID="Panel3" runat="server" BodyPadding="0 0 15 0" Layout="Column" CssClass="formitem" ShowBorder="false" ShowHeader="false">
                                            <Items>
                                                <f:TextBox runat="server" ID="tbxFwdd" Label="服务地点" Margin="0 15 0 0" ColumnWidth="70%" MaxLength="20" EmptyText="限填 20 个汉字 ！" Required="true" ShowRedStar="true"></f:TextBox>
                                                <f:NumberBox runat="server" ID="tbxJlsl" Label="服务时数" ColumnWidth="30%" MaxLength="2" Required="true" ShowRedStar="true"></f:NumberBox>
                                            </Items>
                                        </f:Panel>
                                        <f:Panel ID="Panel4" runat="server" BodyPadding="0 0 15 0" Layout="Column" CssClass="formitem" ShowBorder="false" ShowHeader="false" Hidden="true" >
                                            <Items>
                                                <f:TextBox runat="server" ID="tbxXmmc" Label="项目名称" ColumnWidth="100%" MaxLength="30" EmptyText="限填 30 个汉字 ！" Required="true" ShowRedStar="true"></f:TextBox>
                                            </Items>
                                        </f:Panel>
                                        <f:Panel ID="Panel5" runat="server" BodyPadding="0 0 30 0" Layout="Column" CssClass="formitem" ShowBorder="false" ShowHeader="false">
                                            <Items>
                                                <f:TextArea runat="server" ID="tbxBz" Label="服务内容" ColumnWidth="100%" Height="50px" MinLength="10" MaxLength="100" EmptyText="限填 10 ～ 100 个汉字 ！"></f:TextArea>
                                            </Items>
                                        </f:Panel>
