        ...
        <f:Panel ID="pnlFit" runat="server" Layout="Fit" BodyPadding="1" ShowBorder="true" ShowHeader="false">
            <Items>
                <f:TabStrip runat="server" ID="tabStrip1" TabPosition="Top" ActiveTabIndex="0" ShowBorder="true" EnableTabCloseMenu="false" AutoPostBack="true" >
                    <Tabs>
                        <f:Tab runat="server" ID="tabGrxx" Title="个人基本信息" BodyPadding="10" Layout="HBox">
                            <Items>
                                <f:Panel ID="Panel14" runat="server" BodyPadding="0 0 15 0" BoxFlex="1" Layout="Fit" CssClass="formitem" ShowBorder="false" ShowHeader="false">
                                    <Items>
                                ...
                                <f:Panel ID="Panel15" runat="server" Width="123px"  Margin="0 0 0 0"  BodyPadding="0" ShowHeader="false" ShowBorder="false">
                                    <Items>
                        ...
                        <f:Tab runat="server" ID="tabFzq" Title="发展前信息" BodyPadding="10" Layout="Fit">
                            <Items>
                                <f:SimpleForm ID="SimpleForm2" runat="server" LabelWidth="92" ShowBorder="false" ShowHeader="false" AutoScroll="true">
                                    <Items>
                        ...
                        <f:Tab runat="server" ID="tabFzz" Hidden="true" Title="发展中信息" BodyPadding="10" Layout="Fit">
                            <Items>
                                <f:SimpleForm ID="SimpleForm3" runat="server" LabelWidth="92" ShowBorder="false" ShowHeader="false" AutoScroll="true">
                                    <Items>
                                        <f:Panel ID="Panel10" runat="server" BodyPadding="0 0 15 0" Layout="Column" CssClass="formitem" ShowBorder="false" ShowHeader="false">
                                            <Items>
                                                ...
                                                <f:Label runat="server" ID="lblZsjg" Label="政 审 结 果" Margin="0 15 0 0" ColumnWidth="33%" Text=""></f:Label>                    
                                                <f:Label runat="server" ID="lblDbjg" Label="答 辩 结 果" ColumnWidth="33%" Text=""></f:Label>                            
                                            </Items>
                                        </f:Panel>
                        ...
                        <f:Tab runat="server" ID="tabFzh" Hidden="true" Title="发展后信息" BodyPadding="10" Layout="Fit">
                            <Items>
                                <f:SimpleForm ID="SimpleForm4" runat="server" LabelWidth="92" ShowBorder="false" ShowHeader="false" AutoScroll="true">
                                    <Items>
                                        <f:Panel ID="Panel13" runat="server" BodyPadding="0 0 15 0" Layout="Column" CssClass="formitem" ShowBorder="false" ShowHeader="false">
                                            <Items>
                                                <f:Label runat="server" ID="lblRdrq" Label="入 党 日 期" Margin="0 15 0 0" ColumnWidth="34%" Text=""></f:Label>  
                                        ...
                                        <f:Panel ID="pnlTjYb" runat="server" BodyPadding="0 0 15 0" Layout="Column" CssClass="formitem" ShowBorder="false" ShowHeader="false">
                                            <Items>
                                                ...
                                                <f:HyperLink runat="server" ID="lblSlx1" Label="党员三联系" CssClass="spanLink" ColumnWidth="33%" Text=""></f:HyperLink>                    
                                            </Items>
                                        </f:Panel>
                                        <f:Panel ID="pnlTjZs" runat="server" Hidden="true" BodyPadding="0 0 15 0" Layout="Column" CssClass="formitem" ShowBorder="false" ShowHeader="false">
                                            <Items>
                                                ...
                                                <f:HyperLink runat="server" ID="lblSlx2" Label="党员三联系" CssClass="spanLink" ColumnWidth="33%" Text=""></f:HyperLink>          
