        ...
        private void ShowUI()
        {
            ...
            switch (fzztdm)
            {
                case TStar.Web.Globals.SystemSetting.Fzzt.Ybdy:
                    ...
                    if (this.lblSxhb1.Text != "0") this.lblSxhb1.OnClientClick = wndView.GetShowReference(string.Format("../Xmgl/Sxhblbgr.aspx?fzrbh={0}&fzzt={1}", xs.Pkid, (int)TStar.Web.Globals.SystemSetting.Fzzt.Ybdy), "弹出窗－" + xs.Xm + "－思想汇报列表【发展后】");
                    if (this.lblZyfw1.Text != "0") this.lblZyfw1.OnClientClick = wndView.GetShowReference(string.Format("../Xmgl/Zyfwlbgr.aspx?fzrbh={0}&fzzt={1}", xs.Pkid, (int)TStar.Web.Globals.SystemSetting.Fzzt.Ybdy), "弹出窗－" + xs.Xm + "－志愿服务列表【发展后】");
                ...
                case TStar.Web.Globals.SystemSetting.Fzzt.Zsdy:
                    ...
                    if (this.lblSxhb2.Text != "0") this.lblSxhb2.OnClientClick = wndView.GetShowReference(string.Format("../Xmgl/Sxhblbgr.aspx?fzrbh={0}&fzzt={1}", xs.Pkid, (int)TStar.Web.Globals.SystemSetting.Fzzt.Zsdy), "弹出窗－" + xs.Xm + "－思想汇报列表【发展后】");
                    if (this.lblZyfw2.Text != "0") this.lblZyfw2.OnClientClick = wndView.GetShowReference(string.Format("../Xmgl/Zyfwlbgr.aspx?fzrbh={0}&fzzt={1}", xs.Pkid, (int)TStar.Web.Globals.SystemSetting.Fzzt.Zsdy), "弹出窗－" + xs.Xm + "－志愿服务列表【发展后】");
                    break;
                default:
                    return;
            }
