...
namespace Web.Home
{
    public partial class Homexs : TStar.Web.BasePage
    {
        #region 自定义属性
        ...
        private void ShowUI()
        {
            ...
            // 培养材料数
            this.lblSxhb.Text = xs.Sxhb.ToString();
            this.lblZyfw.Text = xs.Zyfw.ToString();
            this.lblSlx.Text = xs.Slx.ToString();
            this.lblJshj.Text = xs.Jshj.ToString();
            this.lblQtxm.Text = xs.Qtxm.ToString();
