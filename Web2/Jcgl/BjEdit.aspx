    ...
    <form id="form1" runat="server">
        ...
        <f:SimpleForm runat="server" ID="SimpleForm1" BodyPadding="10" LabelWidth="80" ShowBorder="false" ShowHeader="false">
            ...
            <Items>
                ...
                <f:DropDownList runat="server" ID="ddlZybh" Label="专业名称" CssStyle="color:Blue"></f:DropDownList>
                <f:TextBox runat="server" ID="tbxBjmc" Label="班级名称" MaxLength="40" Required="true"></f:TextBox>
            </Items>
        </f:SimpleForm>
    </form>
</body>
