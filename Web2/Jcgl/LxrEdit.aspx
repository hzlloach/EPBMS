<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LxrEdit.aspx.cs" Inherits="Web.Jcgl.LxrEdit" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:SimpleForm runat="server" ID="SimpleForm1" BodyPadding="10" LabelWidth="80" ShowBorder="false" ShowHeader="false">
            ...
            <Items>
                ...
                <f:TextBox runat="server" ID="tbxGh" Label="工　　号" MaxLength="12" Required="true"></f:TextBox>
                <f:TextBox runat="server" ID="tbxXm" Label="姓　　名" MaxLength="40" Required="true"></f:TextBox>
                <f:TextBox runat="server" ID="tbxSjhm" Label="手机号码" MaxLength="40" Required="true"></f:TextBox>
                <f:RadioButtonList runat="server" ID="rblLb" Label="角色类别" Required="true">
                    <f:RadioItem Text="教师" Value="1" Selected="true" />
                    <f:RadioItem Text="学生" Value="2" />
                </f:RadioButtonList>
                <f:RadioButtonList runat="server" ID="rblSj" Label="支部书记" Required="true">
