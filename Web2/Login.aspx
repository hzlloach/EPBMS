...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body style="background-color:#6D0D0F">
        ...
        <f:Window ID="wndReg" runat="server" Title="新用户注册" Width="410px" Height="300px" WindowPosition="Center" Target="Self" EnableMaximize="false" EnableResize="false" EnableDrag="false" EnableIFrame="true" Hidden="true" IsModal="true" CloseAction="Hide" IFrameUrl="Xtgl/Reg.aspx"></f:Window>
        <f:Window ID="wndPwd" runat="server" Title="忘记密码" Width="410px" Height="250px" WindowPosition="Center" Target="Self" EnableMaximize="false" EnableResize="false" EnableDrag="false" EnableIFrame="true" Hidden="true" IsModal="true" CloseAction="Hide" IFrameUrl="Xtgl/Forget.aspx"></f:Window>
    </body>
</html>