...
namespace Web.Tjbb
{
    public partial class Jjfz : TStar.Web.BasePage
    {
        #region 自定义属性

        string DefBll = "hz_jjfz";
        ...
        {
            string cond = string.Format("{0} AND Fzztdm='2'", BLL.Globals.SystemSetting.CondBmDzbbh.Replace("Lxrbh=", "Rdlxrbh1="));
            QueryWhere = cond;
