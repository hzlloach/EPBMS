...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="pnlFit" runat="server" Layout="VBox" BoxConfigAlign="Stretch" BoxConfigPadding="1" BoxConfigChildMargin="0 0 0 0" ShowBorder="false" ShowHeader="false">
            <Items>                       
                <%--查询条件框--%>        
                <f:Panel runat="server" Title="党校培训" ShowBorder="true" ShowHeader="true" EnableCollapse="true">
                    <Items>
                    ...
                    <Items>
                        <f:Grid ID="Grid1" runat="server" Title="Grid1" EmptyText="<img src='/res/images/no_data_found.jpg' alt='暂无数据'/>" AllowPaging="true" AllowSorting="true" EnableCheckBoxSelect="true" EnableTextSelection="true" EnableHeaderMenu="false" ShowBorder="false" ShowHeader="False" IsDatabasePaging="true" DataKeyNames="Pkid,Fzrbh" OnPageIndexChange="Grid1_PageIndexChanged" OnSort="Grid1_Sort" OnRowCommand="Grid1_RowCommand" >
                            <Columns>
                                ...
                                <f:BoundField Width="105px" ColumnID="Xmrq" DataField="Xmrq" SortField="Xmrq" HeaderText="党校结业日期" />
                                <f:BoundField Width="105px" ColumnID="Djmc" DataField="Djmc" SortField="Djmc" HeaderText="党校考核等级" />
