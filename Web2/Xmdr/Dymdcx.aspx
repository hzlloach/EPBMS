<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dymdcx.aspx.cs" Inherits="Web.Xmdr.Dymdcx" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="pnlFit" runat="server" Layout="VBox" BoxConfigAlign="Stretch" BoxConfigPadding="1" BoxConfigChildMargin="0 0 0 0" ShowBorder="false" ShowHeader="false">
            <Items>                       
                <%--查询条件框--%>        
                <f:Panel runat="server" Title="现有党员名单" ShowBorder="true" ShowHeader="true" EnableCollapse="true">
                    <Items>
