...
namespace Web.Xmdr
{
    public partial class Jjfzmdcx : TStar.Web.BasePage
    {
        #region 自定义属性

        string DefBll = "jjfzmdcx";
        string DefSort = "Xh";
        ...
        protected void btnDeleteSel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                BLL.Lcgl.Lc_jjfzmd.Delete(bhs.Substring(1).Split(','));
                this.BindGrid();
        ...
        protected void btnClear_Click(object sender, EventArgs e)
        {
            try
            {
                BLL.Lcgl.Lc_jjfzmd.ClearImport(TStar.Web.Globals.Account.DeptPkid, this.ddlDzb.SelectedIndex > 0 ? this.ddlDzb.SelectedValue : null);
                this.BindGrid();
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                BLL.Lcgl.Lc_jjfzmd.Submit(TStar.Web.Globals.Account.DeptPkid, this.ddlDzb.SelectedIndex > 0 ? this.ddlDzb.SelectedValue : null);
                this.BindGrid();
        ...
        protected void Grid1_RowCommand(object sender, GridCommandEventArgs e)
        {
            ...
            try
            {
                ...
                switch (e.CommandName)
                {
                    case "Delete":
                        title = "删除";
                        BLL.Lcgl.Lc_jjfzmd.Delete(pkid);
                        break;
                }
