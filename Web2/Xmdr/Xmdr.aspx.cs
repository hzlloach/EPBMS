...
namespace Web.Xmdr
{
    public partial class Xmdr : TStar.Web.BasePage
    {
        ...
        protected int[] Columns2Widths = { 110, 200 };
        ...
        protected int[] Columns6Widths = { 200, 120, 100, 120, 80, 120 };
