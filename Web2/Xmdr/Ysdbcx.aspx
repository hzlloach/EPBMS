<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ysdbcx.aspx.cs" Inherits="Web.Xmdr.Ysdbcx" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="pnlFit" runat="server" Layout="VBox" BoxConfigAlign="Stretch" BoxConfigPadding="1" BoxConfigChildMargin="0 0 0 0" ShowBorder="false" ShowHeader="false">
            <Items>                       
                <%--查询条件框--%>        
                <f:Panel runat="server" Title="预审答辩" ShowBorder="true" ShowHeader="true" EnableCollapse="true" CssClass="querypanel">
                    <Items>
                        <f:ContentPanel runat="server" ShowBorder="false" ShowHeader="false" BodyPadding="10 10 5 0">
                            <f:DropDownList runat="server" ID="ddlDbjg" Label="答辩结果" LabelWidth="75" LabelAlign="Right" Width="205px" AutoPostBack="true" OnSelectedIndexChanged="ddlDbjg_SelectedIndexChanged"></f:DropDownList>
                    ...
                    <Items>
                        <f:Grid ID="Grid1" runat="server" Title="Grid1" EmptyText="<img src='/res/images/no_data_found.jpg' alt='暂无数据'/>" AllowPaging="true" AllowSorting="true" EnableCheckBoxSelect="true" EnableTextSelection="true" ShowBorder="false" ShowHeader="False" IsDatabasePaging="true" DataKeyNames="Pkid,Fzrbh" OnPageIndexChange="Grid1_PageIndexChanged" OnSort="Grid1_Sort" OnRowCommand="Grid1_RowCommand" >
                            <Columns>
                                ...
                                <f:BoundField Width="90px" ColumnID="Zsjg" DataField="Zsjg" SortField="Zsjg" HeaderText="政审结果" />
                                <f:BoundField Width="100px" ColumnID="Dbrq" DataField="Dbrq" SortField="Dbrq" HeaderText="答辩日期" />
                                <f:BoundField Width="90px" ColumnID="Dbjg" DataField="Dbjg" SortField="Dbjg" HeaderText="答辩结果" />
