...
namespace Web.Xmdr
{
    public partial class Zzmdcx : TStar.Web.BasePage
    {
        #region 自定义属性

        string DefBll = "zzmdcx";
        string DefSort = "Xh";
        ...
        private void BindData()
        {
            ...
            TUF.Helper.BindDropDownList(BLL.Globals.SystemCode.DtDm_jgzt, this.ddlBjjg, "Mc", "Dm", null, null, "__", "－不限－");
            
            string tblname = TU.Globals.TripleDESEncrypt("转正名单" + BLL.Globals.SystemSetting.EncryptCode);
        ...
        private bool GetQueryResult()
        {
            ...
            if (this.ddlBjjg.SelectedIndex > 0)
                cond += String.Format(" AND Bjjgdm='{0}'", this.ddlBjjg.SelectedValue);
        ...
        protected void btnDeleteSel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                BLL.Lcgl.Lc_zzmd.Delete(bhs.Substring(1).Split(','));
                this.BindGrid();
        ...
        protected void btnClear_Click(object sender, EventArgs e)
        {
            try
            {
                BLL.Lcgl.Lc_zzmd.ClearImport(TStar.Web.Globals.Account.DeptPkid, this.ddlDzb.SelectedIndex > 0 ? this.ddlDzb.SelectedValue : null);
                this.BindGrid();
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                BLL.Lcgl.Lc_zzmd.Submit(TStar.Web.Globals.Account.DeptPkid, this.ddlDzb.SelectedIndex > 0 ? this.ddlDzb.SelectedValue : null);
                this.BindGrid();
