<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mddr.aspx.cs" Inherits="Web.Xmdr.Mddr" %>
        ...
        <f:Panel ID="Panel1" runat="server" Layout="Fit" BoxConfigAlign="Stretch" BoxConfigPadding="1" BoxConfigChildMargin="0 0 0 0" ShowBorder="false" ShowHeader="false">
                ...
                <f:Toolbar ID="Toolbar1" runat="server">
                    <Items>
                        ...
                        <f:ContentPanel ID="ContentPanel1" runat="server" CssClass="divHidden" ShowBorder="false" ShowHeader="false">
                            ...
                            <f:HiddenField ID="hfdTemplateName" runat="server"></f:HiddenField>
            ...
            <Items>
                <f:Panel ID="pnlGrid" runat="server" ShowBorder="false" ShowHeader="false" Layout="Fit">
                    <Items>
                        <f:Grid ID="Grid1" runat="server" Title="Grid1" AllowPaging="true" AllowSorting="false" BoxConfigAlign="Middle" EnableCheckBoxSelect="false" EnableHeaderMenu="false" EnableTextSelection="true" ShowBorder="false" ShowHeader="False" IsDatabasePaging="false">
                            <Columns>
