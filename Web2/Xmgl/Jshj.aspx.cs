...
namespace Web.Xmgl
{
    public partial class Jshj : TStar.Web.BasePage
    {
        #region 自定义属性
        ...
        private string Zbbh
        {
            get { return TU.Globals.BindSystemCode(BLL.Globals.SystemCode.DtJd_khzbLocal, "Zbmc", "Pkid", "竞赛获奖", ""); }
        }
        ...
        private void BindData()
        {
            ...
            btnAddNew.OnClientClick = wndEdit.GetShowReference("JshjEdit.aspx?zb=" + Zbbh, "弹出窗－新增") + "return false;";
        ...
        protected void Grid1_RowDataBound(object sender, GridRowEventArgs e)
        {
            ...
            lblXmmc.Attributes["onclick"] = wndView.GetShowReference(String.Format("JshjView.aspx?pkid={0}", Grid1.DataKeys[e.RowIndex][0].ToString()), "弹出窗－浏览");
        }
