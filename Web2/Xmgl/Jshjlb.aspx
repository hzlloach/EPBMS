<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Jshjlb.aspx.cs" Inherits="Web.Xmgl.Jshjlb" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" Layout="VBox" BoxConfigAlign="Stretch" BoxConfigPadding="1" BoxConfigChildMargin="0 0 0 0" ShowBorder="false" ShowHeader="false">
            <Items>                       
                <%--查询条件框--%>        
                <f:Panel ID="pnlCond" runat="server" Title="竞赛获奖列表" ShowBorder="true" ShowHeader="true" EnableCollapse="true">
                    <Items>
                        <f:ContentPanel runat="server" ID="ContentPanel1" ShowBorder="false" ShowHeader="false" BodyPadding="10 10 5 0">
                            ...
                            <f:DropDownList runat="server" ID="ddlLb" Label="奖项等级" LabelWidth="75" LabelAlign="Right" Width="175px" AutoPostBack="true" OnSelectedIndexChanged="ddl_SelectedIndexChanged"></f:DropDownList>
                    ...
                    <Items>
                        <f:Grid ID="Grid1" runat="server" Title="Grid1" EmptyText="<img src='/res/images/no_data_found.jpg' alt='暂无数据'/>" AllowPaging="true" AllowSorting="true" EnableCheckBoxSelect="false" EnableTextSelection="true" EnableHeaderMenu="false" ShowBorder="false" ShowHeader="False" IsDatabasePaging="true" DataKeyNames="Pkid,Ztdm,Lxrbh" OnPageIndexChange="Grid1_PageIndexChanged" OnSort="Grid1_Sort" OnPreRowDataBound="Grid1_PreRowDataBound" OnRowDataBound="Grid1_RowDataBound">
                            <Columns>
                                ...
                                <%--<f:WindowField Width="50px" ColumnID="lbfView" TextAlign="Center" WindowID="wndView" Icon="Magnifier" HeaderText="浏览" ToolTip="浏览" DataIFrameUrlFields="Pkid" DataIFrameUrlFormatString="ZyfwView.aspx?pkid={0}" Title="弹出窗－浏览竞赛获奖" />--%>
                                <f:WindowField Width="50px" ColumnID="lbfOper" TextAlign="Center" WindowID="wndView" Icon="Magnifier" HeaderText="操作" ToolTip="浏览" DataIFrameUrlFields="Pkid" DataIFrameUrlFormatString="JshjView.aspx?pkid={0}" Title="弹出窗－浏览竞赛获奖" />
