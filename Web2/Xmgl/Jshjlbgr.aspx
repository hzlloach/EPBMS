<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Jshjlbgr.aspx.cs" Inherits="Web.Xmgl.Jshjlbgr" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" Layout="VBox" BoxConfigAlign="Stretch" BoxConfigPadding="1" BoxConfigChildMargin="0 0 0 0" ShowBorder="false" ShowHeader="false">
            <Items>                       
                <%--查询条件框--%>        
                <f:Panel ID="pnlCond" runat="server" Title="竞赛获奖" Hidden="true" ShowBorder="true" ShowHeader="false" EnableCollapse="true">
                    <Items>
                        <f:ContentPanel runat="server" ID="ContentPanel1" ShowBorder="false" ShowHeader="false" BodyPadding="5 15 2 0">
                            <f:DropDownList runat="server" ID="ddlKhzb" Label="奖项等级" LabelWidth="75" LabelAlign="Right" Width="275px" AutoPostBack="true" OnSelectedIndexChanged="ddlKhzb_SelectedIndexChanged"></f:DropDownList>
                    ...
                    <Items>
                        <f:Grid ID="Grid1" runat="server" Title="Grid1" EmptyText="<img src='/res/images/no_data_found.jpg' alt='暂无数据'/>" AllowPaging="true" AllowSorting="true" EnableCheckBoxSelect="false" EnableTextSelection="true" EnableHeaderMenu="false" ShowBorder="false" ShowHeader="False" IsDatabasePaging="true" DataKeyNames="Pkid" OnPageIndexChange="Grid1_PageIndexChanged" OnSort="Grid1_Sort">
                            <Columns>
                                ...
                                <f:BoundField Width="90px" ColumnID="Xmrq" DataField="Xmrq" SortField="Xmrq" HeaderText="获奖日期" />
                                <f:BoundField Width="80px" ColumnID="Djmc" DataField="Djmc" HeaderText="奖项等级" />
                                ...
                                <f:WindowField Width="50px" ColumnID="lbfView" TextAlign="Center" WindowID="wndView" Icon="Magnifier" HeaderText="浏览" ToolTip="浏览" DataIFrameUrlFields="Pkid" DataIFrameUrlFormatString="./JshjView.aspx?pkid={0}" Title="浏览竞赛获奖" />
