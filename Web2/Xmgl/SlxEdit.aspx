<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SlxEdit.aspx.cs" Inherits="Web.Xmgl.SlxEdit" %>
                                ...
                                <f:SimpleForm ID="SimpleForm1" runat="server" ShowBorder="false" ShowHeader="false">
                                    <Items>
                                        ...
                                        <f:Panel ID="Panel2" runat="server" BodyPadding="0 0 15 0" Layout="Column" CssClass="formitem" ShowBorder="false" ShowHeader="false">
                                            <Items>
                                                <f:DropDownList runat="server" ID="ddlDjbh" Label="联系类别" Margin="0 15 0 0" ColumnWidth="70%" Required="true" ShowRedStar="true" Hidden="true"></f:DropDownList>
