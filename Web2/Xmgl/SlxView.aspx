<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SlxView.aspx.cs" Inherits="Web.Xmgl.SlxView" %>
                    ...
                    <Items>
                        <f:Panel runat="server" BodyPadding="8" Layout="Column" ShowBorder="false" ShowHeader="false">
                            <Items>
                                ...
                                <f:Label runat="server" ID="lblLxlb" Label="联系类别" ColumnWidth="25%" Text=""></f:Label>                   
                                <f:Label runat="server" ID="lblLxdx" Label="联系对象" ColumnWidth="25%" Text=""></f:Label>  
                                <f:Label runat="server" ID="lblLxrq" Label="联系日期" ColumnWidth="25%" Text=""></f:Label> 
                            </Items>
                        </f:Panel>                    
                        <f:Panel ID="Panel1" runat="server" Margin="-5 8 8 8"  CssClass="formitem" ShowBorder="false" ShowHeader="false">
                            <Items>
                                <f:Label runat="server" ID="lblLxnr" CssClass="spanMaroon" Label="联系内容" Text=""></f:Label>
                            </Items>
                        </f:Panel>            
                    </Items>
                </f:GroupPanel>   
