...
namespace Web.Xmgl
{
    public partial class SlxView : TStar.Web.BasePage
    {
        #region 自定义属性
        ...
        private void ShowUI()
        {
            ...
            this.lblLxrq.Text = m.Xmrq;
            this.lblLxlb.Text = m.Djmc;
            this.lblLxdx.Text = m.Xmmc.Substring(13);
            this.lblLxnr.Text = m.Bz;
