...
namespace Web.Xmgl
{
    public partial class Sxhb : TStar.Web.BasePage
    {
        #region 自定义属性

        string DefBll = "sxhbcx";
        string DefSort = "Xh,Tjxh DESC";
        ...
        {
            string cond = string.Format("{0}", BLL.Globals.SystemSetting.CondXsbhFzzt);//string.Format("Fzrbh='{0}' AND Fzztdm=(SELECT Fzztdm FROM jc_xs x WHERE x.Pkid=Fzrbh)", TStar.Web.Globals.Account.Pkid);
