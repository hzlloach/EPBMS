...
namespace Web.Xmgl
{
    public partial class SxhbEdit : TStar.Web.BasePage
    {
        ...
        private string deal(string text)
        {
            ...
            {
                if (s == "") continue;
                if (s.IndexOf("党组织：") > -1 && s.IndexOf("党组织") < 4) continue;
                if (s.IndexOf("此致") > -1)
                {
                    rlt += separator + "　".PadRight(2, '　') + s;
                }
                else if (s.IndexOf("敬礼") > -1)
                {
                    rlt += separator + s;
                }
                else if (s.IndexOf("汇报人") > -1 || sm)
                {
                    sm = true;
                    rlt += separator + "　".PadRight(21, '　') + s;
                }
                else
                {
                    rlt += separator + "　".PadRight(2, '　') + s;
            ...
            return rlt.Substring(separator.Length);
        }
