<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sxhblb.aspx.cs" Inherits="Web.Xmgl.Sxhblb" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" Layout="VBox" BoxConfigAlign="Stretch" BoxConfigPadding="1" BoxConfigChildMargin="0 0 0 0" ShowBorder="false" ShowHeader="false">
            <Items>                       
                <%--查询条件框--%>        
                <f:Panel ID="pnlCond" runat="server" Title="思想汇报列表" ShowBorder="true" ShowHeader="true" EnableCollapse="true">
                    <Items>
                        <f:ContentPanel runat="server" ID="ContentPanel1" ShowBorder="false" ShowHeader="false" BodyPadding="10 10 5 0">
                            ...
                            <f:DropDownList runat="server" ID="ddlZt" Label="评阅状态" LabelWidth="75" LabelAlign="Right" Width="175px" AutoPostBack="true" OnSelectedIndexChanged="ddl_SelectedIndexChanged">
                                <f:ListItem Text="未评阅" Value="0" />
                                <f:ListItem Text="退回修改" Value="1" />
                                <f:ListItem Text="退回重写" Value="2" />
                                <f:ListItem Text="评阅通过" Value="3" Selected="true" />
                            </f:DropDownList>
                ...
                <f:Panel ID="pnlGrid" runat="server" ShowBorder="true" ShowHeader="false" BoxFlex="1" Layout="Fit" CssClass="gridpanel">                    
                    ...
                    <Items>
                        <f:Grid ID="Grid1" runat="server" Title="Grid1" EmptyText="<img src='/res/images/no_data_found.jpg' alt='暂无数据'/>" AllowPaging="true" AllowSorting="true" EnableCheckBoxSelect="false" EnableTextSelection="true" EnableHeaderMenu="false" ShowBorder="false" ShowHeader="False" IsDatabasePaging="true" DataKeyNames="Pkid,Shsj" OnPageIndexChange="Grid1_PageIndexChanged" OnSort="Grid1_Sort" OnRowCommand="Grid1_RowCommand" OnPreRowDataBound="Grid1_PreRowDataBound" OnRowDataBound="Grid1_RowDataBound">
                            <Columns>
                                ...
                                <f:TemplateField Width="80px" HeaderText="状态" Hidden="true">
                                    <ItemTemplate>
                                        <asp:Label ID="lblZtmc" runat="server" Text='<%# (Eval("Ztxsmc").ToString()) %>'></asp:Label>
                                    </ItemTemplate>
                                </f:TemplateField>
                                <f:WindowField Width="50px" ColumnID="lbfView" TextAlign="Center" WindowID="wndView" Icon="Magnifier" HeaderText="浏览" ToolTip="浏览" DataIFrameUrlFields="Pkid" DataIFrameUrlFormatString="SxhbView.aspx?pkid={0}" Title="弹出窗－浏览思想汇报" />
                                <f:WindowField Width="50px" ColumnID="lbfOper" TextAlign="Center" WindowID="wndEdit" Icon="None" HeaderText="操作" ToolTip="评阅" DataIFrameUrlFields="Pkid" DataIFrameUrlFormatString="SxhbView.aspx?pkid={0}" Title="弹出窗－浏览评阅" />
    ...
    <f:Window ID="wndEdit" runat="server" Title="评阅" WindowPosition="Center"  Target="Self" Width="1000px" Height="700px" EnableMaximize="false" EnableMinimize="false" EnableResize="false" EnableDrag="false" EnableIFrame="true" IsModal="true" Hidden="true" CloseAction="Hide" OnClose="Window_Close">
    </f:Window>
</body>
</html>
