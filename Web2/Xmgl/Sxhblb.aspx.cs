...
namespace Web.Xmgl
{
    public partial class Sxhblb : TStar.Web.BasePage
    {
        #region 自定义属性
        ...
        private bool GetQueryResult()
        {
            ...
            switch (this.ddlZt.SelectedIndex)
            {
                case 0: // 未评阅
                    ...
                    break;
                case 1: // 退回修改
                    cond += string.Format(" AND Ztdm IN ({0},{1})", (int)TG.SystemSetting.Status.ToBeModified, (int)TG.SystemSetting.Status.InModify);
                    break;
                case 2: // 退回重写
