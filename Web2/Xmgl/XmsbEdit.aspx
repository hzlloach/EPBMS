<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XmsbEdit.aspx.cs" Inherits="Web.Xmgl.XmsbEdit" %>
                                ...
                                <f:SimpleForm ID="SimpleForm1" runat="server" ShowBorder="false" ShowHeader="false">
                                    <Items>
                                        ...
                                        <f:Panel ID="Panel2" runat="server" BodyPadding="0 0 15 0" Layout="Column" CssClass="formitem" ShowBorder="false" ShowHeader="false">
                                            <Items>
                                                <f:Panel ID="Panel3" runat="server" ColumnWidth="70%" BodyPadding="0" Margin="0 15 0 0" Layout="Column" CssClass="formitem" ShowBorder="false" ShowHeader="false">
                                                    <Items>
                                                        <f:DropDownList runat="server" ID="ddlZbbh" Label="项目类别" Width="300px" Required="true" ShowRedStar="true" AutoPostBack="true" OnSelectedIndexChanged="ddlZbbh_SelectedIndexChanged"></f:DropDownList>
                                                        <f:DropDownList runat="server" ID="ddlDjbh" Label="" Width="150px" Margin="0 5" Required="true" ShowRedStar="true" Hidden="true"></f:DropDownList>
                                                    </Items>
                                                </f:Panel>
                                                <f:DatePicker runat="server" ID="dtpXmrq" Label="项目日期" ColumnWidth="30%" EnableEdit="false" Required="true" ShowRedStar="True"></f:DatePicker>
                                            </Items>
                                        </f:Panel>
