...
<body>
                                        ...
                                        <td style="text-align: right;">
                                            ...
                                            <f:Button runat="server" ID="btnUser" Text="" IconUrl="~/res/images/toolbar/user.ico" IconAlign="Left" EnablePostBack="false">
                                                <Menu ID="Menu1" runat="server">
                                                    <f:MenuButton ID="mbnInfo" Text="个人信息" Icon="User" EnablePostBack="false" runat="server">
                                                        <Listeners>
                                                            <f:Listener Event="click" Handler="onUserProfileClick" />
                                                        </Listeners>
                                                    </f:MenuButton>
                                                    <f:MenuButton ID="mbnPwd" Text="修改密码" Icon="UserKey" EnablePostBack="false" runat="server">
                                                        <Listeners>
                                                            <f:Listener Event="click" Handler="onUpdatePwdClick" />
                                                        </Listeners>
                                                    </f:MenuButton>
                                                    <f:MenuSeparator ID="MenuSeparator2" runat="server"></f:MenuSeparator>
                                                    <f:MenuButton ID="mbnExit" Text="安全退出" Icon="DoorOut" EnablePostBack="false" runat="server">
                                                        <Listeners>
                ...
                <f:Region ID="mainRegion" ShowHeader="false" Layout="Fit" Position="Center" runat="server">
                    <Items>
                        <f:TabStrip ID="mainTabStrip" EnableTabCloseMenu="true" ShowBorder="false" runat="server">
                            <Tabs>
                                <f:Tab ID="tabHome" Title="首页" Layout="Fit" Icon="House" runat="server" EnableIFrame="true">
                                    <Items>
                    ...
                    <Items>
                        <f:ContentPanel ID="ContentPanel3" runat="server" ShowBorder="false" ShowHeader="false">
                            <table class="bottomtable">
                                <tr>
                                    <td style="width: 300px;">&nbsp;版本：<a target="_blank" href="javascript:">v<asp:Literal runat="server" ID="litVersion"></asp:Literal></a></td>
    ...
    <f:Window ID="wndInfo" runat="server" Title="修改个人信息" Width="410px" Height="370px" WindowPosition="Center" Target="Self" EnableMaximize="false" EnableResize="false" EnableDrag="false" EnableIFrame="true" Hidden="true" IsModal="true" CloseAction="Hide"></f:Window>
    <f:Window ID="wndPwd" runat="server" Title="修改密码" Width="410px" Height="260px" WindowPosition="Center" Target="Self" EnableMaximize="false" EnableResize="false" EnableDrag="false" EnableIFrame="true" Hidden="true" IsModal="true" CloseAction="Hide"></f:Window>
    ...
    <script>
        ...
        function onUserProfileClick() {
            ...
            window.F("wndInfo").f_show("Xtgl/UserInfo.aspx", "个人信息维护");
        }

        function onUpdatePwdClick() {
            //window.F.alert({ message: '尚未实现', messageIcon: Ext.MessageBox.INFO });
            window.F("wndPwd").f_show("Xtgl/UpdatePwd.aspx");
        }
