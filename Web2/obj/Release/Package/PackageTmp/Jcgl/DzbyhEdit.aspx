<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DzbyhEdit.aspx.cs" Inherits="Web.Jcgl.DzbyhEdit" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:SimpleForm runat="server" ID="SimpleForm1" BodyPadding="10" LabelWidth="80" ShowBorder="false" ShowHeader="false">
            ...
            <Items>
                ...
                <f:Label runat="server" ID="lblDzbmc" Label="党支部名称" CssStyle="color:Blue"></f:Label>
                <f:DropDownList runat="server" ID="ddlDzbbh" Label="党支部名称" CssStyle="color:Blue" Hidden="true"></f:DropDownList>
                <f:TextBox runat="server" ID="tbxUid" Label="登录用户名" MaxLength="40" Required="true"></f:TextBox>
                <f:TextBox runat="server" ID="tbxPwd" Label="登录密码" MaxLength="20" TextMode="Password"></f:TextBox>
                <f:TextBox runat="server" ID="tbxPwd2" Label="确认密码" MaxLength="20" TextMode="Password"></f:TextBox>
            </Items>
        </f:SimpleForm>
    </form>
</body>
