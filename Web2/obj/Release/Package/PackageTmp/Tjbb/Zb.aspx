<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Zb.aspx.cs" Inherits="Web.Tjbb.Zb" %>
                        ...
                        <f:Grid ID="grdXy" runat="server" Title="Grid1" EmptyText="<img src='/res/images/no_data_found.jpg' alt='暂无数据'/>" AllowPaging="false" AllowSorting="false" EnableCheckBoxSelect="false" EnableTextSelection="true" EnableHeaderMenu="false" ShowBorder="false" ShowHeader="false" IsDatabasePaging="false" DataKeyNames="Pkid" OnSort="Grid1_Sort">
                            <Columns>
                                ...
                                <f:GroupField HeaderText="党员获奖情况" TextAlign="Center">
                                    <Columns>
                                        <f:BoundField Width="50px" ColumnID="YjHjs1" DataField="DyYjHjs" HeaderText="院级" TextAlign="Center" /> <%--SortField="YjHjs"--%>
                                        <f:BoundField Width="50px" ColumnID="XjHjs1" DataField="DyXjHjs" HeaderText="校级" TextAlign="Center" /> <%--SortField="XjHjs"--%>
                                        <f:BoundField Width="80px" ColumnID="YsHjs1" DataField="DyYsHjs" HeaderText="校级以上" TextAlign="Center" /> <%--SortField="YsHjs"--%>
                                    </Columns>
                                </f:GroupField>
