<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XmsbView.aspx.cs" Inherits="Web.Xmgl.XmsbView" %>
                    ...
                    <Items>
                        <f:Panel runat="server" BodyPadding="8" Layout="Column" ShowBorder="false" ShowHeader="false">
                            <Items>
                                ...
                                <f:Label runat="server" ID="lblXmrq" Label="项目日期" ColumnWidth="25%" Text=""></f:Label>
                                <f:Label runat="server" ID="lblXmlb" Label="项目类别" ColumnWidth="25%" Text=""></f:Label>    
                            </Items>
                        </f:Panel>                    
                        <f:Panel ID="Panel1" runat="server" Margin="-5 8 8 8"  CssClass="formitem" ShowBorder="false" ShowHeader="false">
                            <Items>
                                <f:Label runat="server" ID="lblXmmc" CssClass="spanMaroon" Label="项目名称" Text=""></f:Label>
                            </Items>
                        </f:Panel>                   
                        <f:Panel ID="pnlBz" runat="server" Margin="-8 8 8 8" Hidden="true" CssClass="formitem" ShowBorder="false" ShowHeader="false">
                            <Items>
                                <f:Label runat="server" ID="lblBz" Label="备　　注" Text=""></f:Label>
                            </Items>
                        </f:Panel>                
                    </Items>
                </f:GroupPanel>   
