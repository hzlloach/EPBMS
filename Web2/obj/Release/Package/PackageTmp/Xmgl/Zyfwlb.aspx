<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Zyfwlb.aspx.cs" Inherits="Web.Xmgl.Zyfwlb" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" Layout="VBox" BoxConfigAlign="Stretch" BoxConfigPadding="1" BoxConfigChildMargin="0 0 0 0" ShowBorder="false" ShowHeader="false">
            <Items>                       
                <%--查询条件框--%>        
                <f:Panel ID="pnlCond" runat="server" Title="志愿服务列表" ShowBorder="true" ShowHeader="true" EnableCollapse="true">
                    <Items>
                    ...
                    <Items>
                        <f:Grid ID="Grid1" runat="server" Title="Grid1" EmptyText="<img src='/res/images/no_data_found.jpg' alt='暂无数据'/>" AllowPaging="true" AllowSorting="true" EnableCheckBoxSelect="false" EnableTextSelection="true" EnableHeaderMenu="false" ShowBorder="false" ShowHeader="False" IsDatabasePaging="true" DataKeyNames="Pkid,Ztdm,Lxrbh" OnPageIndexChange="Grid1_PageIndexChanged" OnSort="Grid1_Sort" OnPreRowDataBound="Grid1_PreRowDataBound" OnRowDataBound="Grid1_RowDataBound">
                            <Columns>
                                ...
                                <f:BoundField Width="60px" ColumnID="Jlsl" DataField="Jlsl" SortField="Jlsl" HeaderText="时数" />
                                <f:TemplateField Width="350px" ColumnID="Xmmc" HeaderText="服务内容">
                                    <ItemTemplate>
                                        <asp:Label ID="lblXmmc" runat="server" Text='<%# Eval("Xmmc").ToString().Substring(11) %>'></asp:Label>
                                    </ItemTemplate>
                                </f:TemplateField>
                                <%--<f:WindowField Width="50px" ColumnID="lbfView" TextAlign="Center" WindowID="wndView" Icon="Magnifier" HeaderText="浏览" ToolTip="浏览" DataIFrameUrlFields="Pkid" DataIFrameUrlFormatString="ZyfwView.aspx?pkid={0}" Title="弹出窗－浏览志愿服务" />--%>
                                <f:WindowField Width="50px" ColumnID="lbfOper" TextAlign="Center" WindowID="wndView" Icon="Magnifier" HeaderText="操作" ToolTip="浏览" DataIFrameUrlFields="Pkid" DataIFrameUrlFormatString="ZyfwView.aspx?pkid={0}" Title="弹出窗－浏览志愿服务" />
